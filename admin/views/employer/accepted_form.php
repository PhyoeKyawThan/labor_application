...
<head>
    ...
    <title>Two-Page Burmese Form</title>
    ...
    <style>
        ...
        .a4-container {
            margin: 20px auto;
            width: 210mm;
            min-height: 297mm; /* Use min-height for pages with variable content */
            padding: 20mm;
...
<body>
    ...
    <div class="controls-container">
        <button onclick="downloadTwoPagePdf()">Confirm</button>
    ...
    <div class="a4-container">
        ...
        <div class="main-body">
            ...
            <p>
                ၁။ အထက်ပါကိစ္စနှင့်ပတ်သက်၍ရည်ညွှန်းပါစာဖြင့်အကြောင်းကြားချက်အရ <?= $department ?> ဌာနတွင် လစ်လပ်‌လျှက်ရှိသော
                <?= $position ?> ရာထူး နေရာအတွက် အလုပ်လုပ်ကိုင် သူများစာရင်း အလလခပုံစံ(၆) (၂)နှစ်စုံအား ရွေးချယ်နိုင်ပါရန်
    ...
    <div class="a4-container employees">
            ...
            <tbody>
                ...
                foreach ($employees as $index => $e):
                    ...
                    <tr>
                        ...
                        <td><?= $reg_date_components['day'].'/'.$reg_date_components['month'].'/'.$reg_date_components['year'] ?></td>
        ...
        <p>
            <div style="height: 50px; width: 100%; border: 1px dashed #ccc; text-align: center; line-height: 50px;">
                ဒါရိုက်တာလက်မှတ်
            </div>
        </p>
    </div>
