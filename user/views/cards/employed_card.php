...
foreach ($employees as $emp):
    ...
    <div id="employed-card-<?= $emp['nrc'] ?>" class="employed-card">
        ...
        <p>
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil minus facilis aliquam, molestias fuga blanditiis doloremque voluptatum voluptatem. Repudiandae, dolores perspiciatis. Fuga corporis quod facilis eum nemo deleniti sunt architecto!
        </p>
        <div class="direction-sign">
            <img src="/labor_application/importants/director_sign.png" alt="" srcset="">
        </div>
        <div class="stamp">
...
function downloadCard(cardId) {
    ...
    const allCards = document.querySelectorAll('.employed-card');
    allCards.forEach(c => {
        if (c.id !== cardId) {
...
<style>
    ...
    .direction-sign, .stamp {
        position: absolute;
        bottom: 20px;
        opacity: 0.5;
    }
    .direction-sign img, .stamp img {
        width: 100px;
        height: auto;
    }
    .direction-sign {
