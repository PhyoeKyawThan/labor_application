...
--
-- Host: localhost
-- Generation Time: Aug 04, 2025 at 12:35 PM
...
CREATE TABLE `employee_req_form` (
  ...
  `po_box_number` varchar(50) DEFAULT NULL,
...
INSERT INTO `employee_req_form` (`id`, `user_id`, `name`, `position`, `department_address`, `po_box_number`, `phone`, `report_receiver`, `submitted_at`) VALUES
(1, 14, 'asdf', 'asdf', 'asdf', 'asdf', '0989893498', 'asdfasdf', '2025-08-03 19:06:34');
